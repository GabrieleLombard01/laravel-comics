...
Route::get('/comics', function () {
    $comics = [
        [
            ...
            "thumb" => "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQiQ-tk1wQrP3Y4vw0lT3Z8PMFbTRyenk7u48AbFYeyG7ZngPvy",
            "price" => "$19.99",
        ...
        [
            ...
            "thumb" => "https://m.media-amazon.com/images/I/61fl-uL6QgL.jpg",
            "price" => "$2.99",
            "series" => "Batgirl",
        ...
        [
            ...
            "thumb" => "https://m.media-amazon.com/images/I/51cpFaFETbL.jpg",
            "price" => "$2.99",
        ...
        [
            ...
            "thumb" => "https://images.randomhouse.com/cover/9781779510136",
            "price" => "$16.99",
            "series" => "Catwoman",
    ...
    return view('comics.index', ['products' => $comics]);
})->name('comics');
